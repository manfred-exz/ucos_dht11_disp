...
/*#include "..\TI_C6711\TEST\includes.h" */
#endif
...
INT8U  OSTaskChangePrio (INT8U oldprio, INT8U newprio)
{
    ...
    if (OSTCBPrioTbl[newprio] != (OS_TCB *)0){                 /* New priority must not already exist */
        ...
        if ( (ptcb != (OS_TCB *)0) && (ptcb != (OS_TCB *)1) ) {                              /* Task to change must exist           */
...
INT8U  OSTaskDel (INT8U prio)
{
  ...
  //  self = self;		//avoid the warning of C compiler
    ...
    if ( (ptcb != (OS_TCB *)0) && (ptcb != (OS_TCB *)1) ){                                       /* Task to delete must exist      */
...
INT8U  OSTaskResume (INT8U prio)
{
    ...
    OS_ENTER_CRITICAL();
    ptcb = OSTCBPrioTbl[prio];
    if ( (ptcb == (OS_TCB *)0) || (ptcb == (OS_TCB *)1) ) {                                  /* Task to suspend must exist          */
        OS_EXIT_CRITICAL();
...
INT8U  OSTaskStkChk (INT8U prio, OS_STK_DATA *pdata)
{
    ...
    ptcb = OSTCBPrioTbl[prio];
    if ( (ptcb == (OS_TCB *)0) ||(ptcb == (OS_TCB *)1) ){                         /* Make sure task exist                         */
        OS_EXIT_CRITICAL();
...
INT8U  OSTaskQuery (INT8U prio, OS_TCB *pdata)
{
    ...
    ptcb = OSTCBPrioTbl[prio];
    if ( (ptcb == (OS_TCB *)0) || (ptcb == (OS_TCB *)1) ) {                             /* Task to query must exist                 */
        OS_EXIT_CRITICAL();
        return (OS_PRIO_ERR);
    }
